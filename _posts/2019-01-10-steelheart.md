...
A fun, fast-paced read that simply does not let up. It's based on the idea that some mysterious force has given a variety of superpowers to a small number of people, now known as epics. The catch: instead of turning these people into superheroes, they have all become supervillains, and have taken over the world.   
