...
- It's one of the most comprehensive books on DevOps out there, but it's not well written. 
- It covers just about every important DevOps practice, but you walk away without any clear idea of how to implement those practices. 
- It presents a number of case studies of the successful DevOps transformations at famous companies, but it's not clear how to transform your own company. 

In other words, instead of a tutorial that teaches you how to become great at DevOps, you merely get a description of the DevOps world.   
...
Of course, I don't want to imply it's all bad. The book covers the full gamut of DevOps topics, including:
