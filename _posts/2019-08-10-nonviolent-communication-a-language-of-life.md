...
This step calls for observation (i.e., the facts) and not evaluation (i.e., your judgements). Learn to separate the two!
...
This step calls for feelings. Note that each person is responsible for their own feelings, and only their own feelings.
