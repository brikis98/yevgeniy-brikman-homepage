...
- **_Not_ evaluation**: do _not_ state your judgements. 
...
- **Only _your_ feelings.** You can't control or take responsibility for other people's feelings, nor they yours.   
...
- **Needs are few and universal.** E.g., The need for acceptance, connection, safety, joy, and so on. You can find the [full list here](https://www.cnvc.org/training/resource/needs-inventory).   
...
- **Ask for positive things, rather than telling others what _not_ to do.** 
    ...
    - Side note: this idea also came up in _Crucial Conversations_!   
...
- **Empathy and understanding.** The later parts of the book focus a lot on empathy and deeply understanding what the other person is thinking as a key technique for communication. 
    ...
    - This overlaps a lot with the ideas I had read earlier in _Crucial Conversations_ and _Never Split the Difference_.
