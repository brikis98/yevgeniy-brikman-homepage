...
A good book to read for any coder. Perhaps not as thorough as _Code Complete_ but much more effective than _Pragmatic Programmer_.   
...
- The rules and principles fall out of this process and the reader is a part of developing them, which is an effective way to learn.  
- Good discussion for why clean code matters in the intro chapters. 

## The not so good

- Not enough discussion of real world trade-offs. The book brushes them aside and claims that the programmer should *always* write the most clean code possible; what is not mentioned is to what extent to do this and when. In fact, the book compares code to poetry and art and makes a point to mention that neither is ever done. And yet, everyone needs to ship at some point. So when is code not just clean, but clean enough?  
- The chapters have different authors, so a few are weaker than others. 
- The book is too tailored to Java and imperative/OO programming. Similar to _Code Complete_, this book would benefit from discussing functional programming, which addresses many of the lessons/problems.   

## Quotes

Some fun quotes from this book:  
