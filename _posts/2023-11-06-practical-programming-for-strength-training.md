...
2. Give your body enough time to recover (which is when you actually get stronger).   
...
For advanced and elite lifters, training closer to their genetic potential, it takes still more stress to disrupt homeostasis (e.g., many more sets with much heavier weights across many workouts), and therefore, even more time to recover (multiple weeks), so they need routines that vary exercises and volume throughout the month, or even multiple months, making progress very slowly.  
 ...
 ![](https://i.imgur.com/8kZlp3E.jpeg)  
  
 ![](https://i.imgur.com/opKMTX3.jpg)  
  
 ![](https://i.imgur.com/m6Aew7r.jpg)  
...
2. Type IIa and IIb muscle fibers primarily rely on anaerobic metabolism, so they can generate much more force, but they fatigue much faster.  
...
- If you're looking to build strength, you need to do training that uses Type II muscle fibers, especially type IIb, which means low reps, heavy weights.   
- If you're looking to build muscle mass (hypertrophy), you need to do training that uses both types of Type II muscle fibers, which means medium reps and medium weights.   
- If you're looking to build long-term endurance, you need to do training that focuses on Type I muscle fibers, which means doing cardio such as running and biking.  
  
 ![](https://i.imgur.com/cDOUs5G.jpg)  
...
- Use 50-75% of your 1RM.  
- Move the bar as fast as possible. It's all about acceleration, which requires significant effort & focus.  
- Do lots of sets, with just a few reps, and only a short rest time between sets. Example: 10 sets of 2 reps with 1 minute between sets.  
...
- Monday: 5 sets of 5  
- Wednesday: 2 light sets of 5  
- Friday: 1 heavy set of 5 (alternatives: 1RM, 2RM, 3RM, or dynamic effort sets)  
...
_[Intermediate] Split Routine_  
  
Example 1 (track & field athlete):  
  
- Monday: squat, press  
- Wednesday: pull (e.g., clean, snatch) and back  
- Thursday: squat, press  
- Saturday: pull (e.g., deadlift)  
  
Example 2 (powerlifter):  
  
- Monday: bench press and related exercises  
- Wednesday: heavy squat, lighter deadlift  
- Thursday: bench press and related exercises  
- Saturday: lighter squat, heavy deadlift  
