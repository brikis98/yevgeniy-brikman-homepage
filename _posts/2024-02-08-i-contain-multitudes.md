...
tags: ["Review: Nonfiction", "4 Stars", "Biology", "Detailed Notes"]
...
header_image_caption: "'I Contain Multitudes' by Ed Yong"
date: "2024-02-08"
---

Ed Yong has a great way of making you see the world differently. This book isn't quite as good as _An Immense World_, but still super interesting. It focuses on the world of microbes, and after reading it, you'll never think about bacteria, viruses, etc. the same way again.   
...
- **Multicellular life arose when one microbe permanently absorbed another.** The smaller one became mitochondria, producing energy (ATP) to make multicellular life possible. As best as we can tell, this has only happened once in all of history, and all multicellular life descends from this.  
  
- **Microbes vs pathogens.** We tend to think of microbes as dirty and bad, but that really only applies to pathogens, which are a tiny, tiny percent of all microbes. The vast majority of microbes have no impact on human health, and many have a positive impact, either directly on us, or by supporting the ecosystem that we depend on.  
