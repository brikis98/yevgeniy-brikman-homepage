...
How does CSS do it? Well, you can try `text-align: center`. This works occasionally, 
but typically only on text or inline elements. Fine, it is called 
...
`Padding` and `margin` should be simple, right? Nope, each browser does its own 
