...
header_image_caption: "'Getting Real' by Jason Fried, David Heinemeier Hansson, and Matthew Linderman"
date: "2015-01-17"
---
...
- **Building for yourself is all it takes to find a market**: tell that to the many engineers who built something that *only* they would want.
- **Everything can be self-funded**: many business cannot.
- **Everyone should give away all of their data for free**: unless, of course, data is your differentiator, which it is for many companies.  
  
It's not all bad, of course. The advice on design is actually quite good, mostly because it sticks with very concrete details: 

- Avoid too many preferences/settings in an app.
- Design for regular, blank, and error states.
- Copywriting is part of the design.
- Your app has a voice. 

And some of the quotes from third parties are decent too.   
