...
redirect_from:
  - "/writing/2015/12/31/look-back-2015"
  - "/writing/2015/12/31/look-back-2015/"
---
  ...
  {% for popular_post_id in site.data.yir_2015["popular_blog_posts"] %}
    {% for post in site.posts %}
      {% if popular_post_id == post.id %}
        {% include post-outline.html post=post post_title_element=4 exclude_divider="true" %}
      {% endif %}
    {% endfor %}
  {% endfor %}
</div>
  ...
  {% for project_name in site.data.yir_2015["new_projects"] %}
    {% for project in site.data.projects %}
      {% if project_name == project.name %}
        {% include project-outline.html project=project header_size=4 exclude_divider="true" %}
      {% endif %}
    {% endfor %}
  {% endfor %}
</div>
