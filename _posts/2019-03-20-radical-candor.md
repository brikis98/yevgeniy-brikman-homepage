...
header_image_caption: "'Radical Candor' by Kim Malone Scott"
date: "2019-03-20"
---
...
{% include image.html path="reviews/radical-candor-grid.png" %}
...
It's critical to avoid the _fundamental attribution error_, where you focus on what someone did rather than who they are. The former is something the person can fix; the latter isn't.  
...
- That means the goal of a manager is to get things right; this is NOT the same as the manager _being_ right. 
...
- **Ensure everyone gets an equal voice at meetings.** 
    ...
    - You have to _actively_ solve this. 
