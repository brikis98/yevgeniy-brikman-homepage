---
layout: post
title: "Review: Behind the Cloud by Marc Benioff and Carlye Adler"
...
- In an era where buying software meant spending months and millions of dollars to set it up, Salesforce shows up with a Software as a Service (SaaS) model, where you can access the product instantly via the Internet and all it costs you is $50/user/month. 
- It seems like an obvious idea now, but at the time, it was something new.
- I love how that's all captured in a simple, 2-word slogan: "no software."  
  
## Forums and marketplaces

Salesforce was one of the first companies to provide: 

- An online forum where customers could provide feedback.
- A platform/marketplace where developers could build their own products on top of Salesforce's APIs. 

Again, both of these ideas seem "obvious" now, but not so much 10-15 years ago.  
  
## Marketing techniques

Some of the marketing techniques they used were very clever. 

- Finding a competitor's conference
- Setting up fake protests around them
- Paying to show Salesforce ads in all the taxis in that city

They also did a superb job of establishing a rapport with reporters and "leaking" important news to them proactively.  
  
## The 1-1-1 model of philanthropy

The ideas around charity and philanthropy are fantastic. They use a "1-1-1 model": 

- 1% of the company's equity goes into a charity foundation (so as the company becomes more successful, so does the foundation)
- Employees are encouraged to spend 1% of their time (4 hour per month) on philanthropic efforts
- 1% of product efforts go towards philanthropic endeavours (e.g., discounts for nonprofits and features for charities, such as a way to accept donations online). 
- Another "1" you could add to the list is to dedicate 1% of profits to charities. 

This sort of thing is a win all around. 

- It's the right thing to do: if you were able to build a successful company, you should give something back. 
- It's great branding: I have a far higher opinion of Salesforce now as a company. 

I'm considering implementing this same system at my own company.  

## Employee rewards  

- There's a great discussion of how to reward employees, not just with bonuses, but with things that will have a much bigger impact on their lives, such as fully-paid vacations to Maui for the employee and their family. 
- This sort of vacation and a bonus may cost the company roughly the same as a bonus, but a bonus will barely be remembered as it quietly gets direct deposited into the employee's account.
- On the other hand, a vacation will create memories the employee—and their family—will cherish their whole lives.   

## V2MOM planning model

The model they use for planning seems simple and effective. It's called "V2MOM", which stands for: 
...
I can see a lot of value to writing up a V2MOM one-pager once per year or per quarter, as a quick way to get clarity around the company's goals.  

## Weaknesses of the book

There's a lot of goodness in this book, but it's surrounded by a lot of crap. 

- Some of the "plays" are little more than platitudes: "build the software the right way out of the gate." 
- The writing is stodgy and lacks personality (being a list of somewhat disconnected bullet points doesn't help).
- Many of the plays won't apply to most founders, because let's face it, we don't all have the advantages that Marc Benioff did when he started Salesforce. Benioff was a former Oracle exec who was able to seed the company with $6M of his own money, had easy access to loads more money (his personal friends, including Oracle founder Larry Ellison, invested millions), talent (he openly admits to agreeing with Ellison to hire no more than 3 Oracle employees—isn't that collusion?), PR (including personal connections to the Wall Street Journal, Fortune, Forbes, famous ad agencies, etc.), and a network of potential customers. So if you have all that, you too can build a company like Salesforce!  
